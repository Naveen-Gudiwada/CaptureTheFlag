...
<div class="pop-up-wrapper">
  <div class="pop-up">
    <p id="pop-up"><h2>Great! You found another gift box 🎁</h2>
        <h3>But a mysterious man walking in that way asks you to solve this riddle. Will you try?</h3></p>
    <div class="button-wrapper">
    <form action="stage1.php">
...
<div class="bg-wrapper">
 ...
 <script>
    ...
    function sResponse()
    {
        windows.location.href="stage1.php";
    }
    </script>
</body>
</html>