...
<div class="pop-up-wrapper">
  <div class="pop-up">
    ...
    <p><h2>You won this competition from the souvenir seller and take the gift box! It has a "r-3" on it. 
      I hope you have not forgotten all the previous letters?</h2></p>
    <div class="button-wrapper">
    <form action="challenges1.php" method="post">
